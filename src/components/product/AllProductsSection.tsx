...
import { Bot, Mic, MessageSquare, Linkedin, Database, ArrowRight, Sparkles, Play, ChevronRight, Video, Leaf } from 'lucide-react';
...
interface Product {
    ...
    href: string;
    features: string[];
    category: 'core' | 'enterprise' | 'interview' | 'ecommerce';
}
...
const products: Product[] = [
    ...
    },
    {
        id: 'hiyring',
        name: 'Hiyring.com',
        description: 'AI-powered hiring with autonomous video interviews.',
        shortDesc: 'Screen thousands of candidates in minutes. Reduce time-to-hire by 85%.',
        icon: Video,
        href: '/products/hiyring',
        features: ['AI Interviews', 'Bias-Free', 'Smart Ranking'],
        category: 'interview'
    },
    {
        id: 'vedashi',
        name: 'Vedashi.com',
        description: 'Modern Ayurvedic wellness eCommerce platform.',
        shortDesc: '250K+ wellness protocols delivered with 98% satisfaction.',
        icon: Leaf,
        href: '/products/vedashi',
        features: ['Clinically Tested', 'Organic', 'Personalized'],
        category: 'ecommerce'
    }
];
...
const AllProductsSection = () => {
    ...
    const interviewProducts = products.filter(p => p.category === 'interview');
    const ecommerceProducts = products.filter(p => p.category === 'ecommerce');
        ...
        >
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {/* New Row: AI Interview & Ecommerce Solution */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mt-12">
                        ...
                        <div>
                            ...
                            {/* Products */}
                            <div className="space-y-4">
                                {interviewProducts.map((product, idx) => (
                                    <div key={product.id}>
                                        <ProductCard
                                            product={product}
                                            index={idx + 5}
                        ...
                        <div>
                            ...
                            {/* Products */}
                            <div className="space-y-4">
                                {ecommerceProducts.map((product, idx) => (
                                    <div key={product.id}>
                                        <ProductCard
                                            product={product}
                                            index={idx + 6}
                    ...
                    <motion.div
                        ...
                        className={`
                            mt-12 p-6 rounded-2xl border-2 border-dashed max-w-lg mx-auto
                            ${theme === 'dark'
