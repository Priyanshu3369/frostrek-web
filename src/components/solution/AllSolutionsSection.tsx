...
import { TrendingUp, Headset, ShoppingCart, Server, ArrowRight, Sparkles, Play, ChevronRight, Video, Leaf } from 'lucide-react';
...
const solutions: Solution[] = [
    ...
    },
    {
        id: 'ai-interview',
        name: 'AI for Hiring',
        description: 'AI-powered video interviews for smarter recruitment.',
        shortDesc: 'Screen thousands of candidates autonomously. Reduce time-to-hire by 85%.',
        icon: Video,
        href: '/solutions/ai-interview',
        features: ['Video Interviews', 'Bias-Free', 'Smart Ranking'],
    },
    {
        id: 'ecommerce-wellness',
        name: 'AI for Wellness eCommerce',
        description: 'Authentic Ayurveda powered by technology.',
        shortDesc: 'Personalized wellness protocols with clinically validated products.',
        icon: Leaf,
        href: '/solutions/ecommerce-wellness',
        features: ['Personalized', 'Clinical', 'Sustainable'],
    }
];
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        {/* Right Column */}
                        <div className="space-y-4">
                            {solutions.slice(3, 6).map((solution, idx) => (
                                <div key={solution.id}>
                                    <SolutionCard
                                        solution={solution}
                                        index={idx + 3}
