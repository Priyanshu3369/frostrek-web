    ...
    { label: 'Experience', href: '/experience' },
    {
        ...
        megaMenu: [
            ...
            },
            {
                title: 'AI Interview',
                items: [
                    { name: 'Hiyring.com', href: '/products/hiyring', desc: 'AI-powered hiring with autonomous video interviews.', icon: 'Video' },
                ],
            },
            {
                title: 'Ecommerce Solution',
                items: [
                    { name: 'Vedashi.com', href: '/products/vedashi', desc: 'Modern Ayurvedic wellness eCommerce platform.', icon: 'Leaf' },
                ],
            },
        ],
    },
        ...
        megaMenu: [
            {
                ...
                items: [
                    ...
                    { name: 'AI for Hiring', href: '/solutions/ai-interview', desc: 'AI-powered video interviews for smarter recruitment.', icon: 'Video' },
                    { name: 'AI for Wellness eCommerce', href: '/solutions/ecommerce-wellness', desc: 'Authentic Ayurveda powered by technology.', icon: 'Leaf' },
                ],
            },
        ],
    },
